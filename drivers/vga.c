...
static int vga_put_char(char c, int col, int row, char attr);
...
void kprint_at(char *message, int col, int row)
{
	...
	int i = 0;
	while (message[i] != '\0') {
		offset = vga_put_char(message[i++], col, row, WHITE_ON_BLACK);
...
void kprint_backspace()
{
	...
	vga_put_char(0x08, col, row, WHITE_ON_BLACK);
}
 ...
 */
int vga_put_char(char c, int col, int row, char attr)
{
